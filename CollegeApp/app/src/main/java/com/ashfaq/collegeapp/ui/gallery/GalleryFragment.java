package com.ashfaq.collegeapp.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    RecyclerView convoRecycler ,technicalRecycler,otherRecycler;
    ...
    private void getTechImage() {
        ...
        reference.child("Technical Day").addValueEventListener(new ValueEventListener() {
